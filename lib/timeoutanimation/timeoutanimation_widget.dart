...
class TimeoutanimationWidget extends StatefulWidget {
  const TimeoutanimationWidget({Key key}) : super(key: key);

  @override
  _TimeoutanimationWidgetState createState() => _TimeoutanimationWidgetState();
}

class _TimeoutanimationWidgetState extends State<TimeoutanimationWidget>
